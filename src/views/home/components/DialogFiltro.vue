          ...
          <v-container>
            <v-row>
              ...
              <v-col cols="12" sm="9" md="9">
                <v-text-field v-model="filtro.nome_curso" label="Nome do Curso"></v-text-field>
              </v-col>
                ...
                <v-row>
                  <v-col class="pr-4">
                    <v-slider
                      ...
                      :disabled="filtro.permanencia.ativa"
                      hide-details
                    >
                ...
                <v-row>
                  <v-col class="pr-4">
                    <v-slider
                      ...
                      :disabled="filtro.conclusao.ativa"
                      hide-details
                    >
                      <template v-slot:append>
                        <v-text-field
                ...
                <v-row>
                  <v-col class="pr-4">
                    <v-slider
                      ...
                      :disabled="filtro.desistencia.ativa"
                      hide-details
                    >
                      <template v-slot:append>
                        <v-text-field
...
export default {
  ...
  computed:{
    ... mapGetters(['getLocalizacaoState'])
  },
  methods: {
    showAdd() {
      this.dialog = true;
